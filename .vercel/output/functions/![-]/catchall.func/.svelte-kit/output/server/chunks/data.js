...
const heroContent = {
  ...
  subtitle: "Founder and full-stack architect focused on building high-performance, AI-powered SaaS products with clean design, strong systems thinking, and production-grade engineering.",
  cta: [
  ...
  expertise: [
    {
      ...
      description: "Designing scalable SaaS architectures, defining data models, optimizing performance, and building reliable backend systems."
    },
    {
      title: "Full-Stack Engineering",
      description: "Developing robust web platforms with modern JavaScript frameworks, RESTful APIs, and production-ready infrastructure."
    },
    {
      title: "Experience & Interface Design",
      description: "Crafting intuitive, high-performance interfaces that balance usability, clarity, and aesthetic precision."
    }
  ]
};
const experience = [
...
const projects = [
  {
    title: "Fairlx",
    description: "An open-source, AI-powered Project Management Tool built on a usage-based SaaS model to help teams plan, execute, and scale projects with automation-first workflows.",
  ...
  },
  {
    ...
    description: "A premium educational platform built to streamline academic workflows and deliver a structured digital experience aligned with the CBSE curriculum.",
  ...
  {
    title: "Project TAPIT",
    description: "A cross-platform application focused on frictionless interaction and utility-driven design, built for real-world performance.",
  ...
  },
  {
    ...
    description: "A finance-oriented web platform delivering clean interface design, performance optimization, and reliable data presentation.",
...
const fairlxContent = {
  title: "Fairlx",
  subtitle: "An open-source, AI-powered Project Management Tool built on a usage-based SaaS model.",
